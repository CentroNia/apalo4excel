...
#ifndef PALOEXCEPTIONFACTORY_H
#define PALOEXCEPTIONFACTORY_H

#define MSG_ERROR_DATABASE_NOT_FOUND    "Libpalo_ng : Database not found"
#define MSG_ERROR_DIMENSION_NOT_FOUND   "Libpalo_ng : Dimension not found"

#define MSG_ERROR_ELEMENT_NOT_FOUND     "Libpalo_ng : Element not found"
#define MSG_ERROR_CUBE_NOT_FOUND        "Libpalo_ng : Cube not found"
...
class LIBPALO_NG_CLASS_EXPORT PaloExceptionFactory : public ExceptionFactory {
public:
	enum ErrorType {
