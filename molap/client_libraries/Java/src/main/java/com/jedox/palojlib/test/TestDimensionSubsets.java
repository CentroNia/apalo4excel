...
public class TestDimensionSubsets {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String[] vars = dim.getGlobalSubsetVariables("KaisSubset");
			for(String v:vars){
				System.out.println(v);
			}
			
			IVariable var1 = new Variable("C1","Monitors");
			IVariable var2 = new Variable("C2","All Products");			
			IVariable[] variables = new IVariable[2];
			variables[0] = var1;
			variables[1] = var2;
			
			IElement[] result = dim.evaluateGlobalSubset("KaisSubset2", variables);
