...
public class ConnectionHandler {
	...
	private static final String SERVER_SAVE_REQUEST = "/server/save?";
	...
	protected void save(boolean complete) throws PaloException, PaloJException {
		StringBuilder SERVER_SAVE_REQUEST_BUFFER = new StringBuilder(SERVER_SAVE_REQUEST);
		StringBuilder currentRequest = SERVER_SAVE_REQUEST_BUFFER.append("complete=").append(complete?"1":"0");
		HttpHandlerManager.getInstance().getHttpHandler(connectionConfiguration.getContextId()).send(currentRequest,true,false);
