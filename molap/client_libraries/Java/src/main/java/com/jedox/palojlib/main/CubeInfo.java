...
public class CubeInfo extends ComponentInfo {
	...
	private static Logger log = LoggerManager.getInstance().getLogger(CubeInfo.class.getSimpleName());
	...
	protected CubeInfo(int[] dimensionIds,String numberOfCells,String numberOfFilledCells,String type, String cb_token,String cc_token){
		...
		this.CB_token = parseLong(cb_token);
		this.CC_token = parseLong(cc_token);
	}
	...
	private BigInteger parseNumber(String number) {
		try {
			...
			log.warn("jlib parsing error for BigDecimal: "+number);
	...
	private Long parseLong(String input) {
		try {
			...
			log.warn("jlib parsing error for Long: "+input);
