...
public interface IConnection {
	 ...
	 * close the connection. 
	 * This should be done when finished from the connection to expire the olap session.
	 * @param Stop true will stop any active job for this session will be stopped, false no jobs will be stopped.
	 * @throws PaloException
	 */
	...
	/**
	 * help method that calls #{@link IDatabase.save(false)} for all server databases, use {@link #save(boolean)} instead to do save operations.
	 * @throws PaloException
	 * @throws PaloJException 
	 */
	@Deprecated
	 ...
	 * @param complete when true then also databases and all cubes data will be saved, otherwise false.
	 * @throws PaloException
	 * @throws PaloJException 
	 */
