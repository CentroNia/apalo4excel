...
public interface IDatabase {
	 ...
	 * @param name name of the new dimension
	 * @param type type of the dimension (normal, user info)
	 * @return the newly created dimension
	 * @throws PaloException
	 * @throws PaloJException 
	 */
	 ...
	 * @param name name of the new cube
	 * @param dimensions list of dimensions
	 * @param type type of the cube (normal, user info)
	 * @return the newly created cube
	 * @throws PaloException
	 * @throws PaloJException 
	 */
	...
	/**
	 * save the database to disk, use {@link #save(boolean)} instead to do save operations.
	 * @throws PaloException
	 * @throws PaloJException 
	 */
	@Deprecated
	 ...
	 * @param complete when true also all cubes data will be saved, otherwise false.
	 * @throws PaloException
	 * @throws PaloJException 
	 */
