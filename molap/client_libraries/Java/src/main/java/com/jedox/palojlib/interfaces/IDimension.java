...
public interface IDimension {
	 ...
	 * to methods {@link #addBaseElement(String, ElementType) addBaseElement}, {@link #addAttribute(String, ElementType) addAttribute} 
	 ...
	 */
	public String[] getGlobalSubsetVariables(String name);
	
	/**
	 * evaluate the given subset with the set of variables 
	 * @param name name of the subset
	 * @param subsetVariables subset variables (can be empty)
	 * @return the list of elements in the dimension that matches the subset
	 */
	public IElement[] evaluateGlobalSubset(String name, IVariable[] subsetVariables);
	
	/**
	 * get the list of global subsets
	 * @return list of global subsets
	 */
