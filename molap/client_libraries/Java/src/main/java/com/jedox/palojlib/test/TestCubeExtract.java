...
public class TestCubeExtract {
	...
	public static void main(String[] args) {
		...
		try {
			...
			path[0] = dims[0].getElementByName("Desktop L", false);
			path[1] = dims[1].getElementByName("Germany", false);
			path[2] = dims[2].getElementByName("Jan", false);
			path[3] = dims[3].getElementByName("2014", false);
			path[4] = dims[4].getElementByName("Actual", false);
			path[5] = dims[5].getElementByName("Units", false);
