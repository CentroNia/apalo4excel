...
#define XLFUNC_CRASH_GUARD()    if(Excel4(xlfCaller, NULL, 0) != xlretSuccess) return TempErr(xlerrNA);
#else
#define XLFUNC_CRASH_GUARD()    if(Excel12(xlfCaller, NULL, 0) != xlretSuccess) return TempErr(xlerrNA);
#endif
