...
namespace Palo {
	namespace XLL {
		...
		public:
			...
			explicit XLCell( GenericContext& settings, typename ExcelStructsWrapper::LPXLOPERX oper, bool is_retval = false );
			~XLCell();

			typename ExcelStructsWrapper::LPXLOPERX release();
           ...
           std::unique_ptr<GenericCell> clone() const;
			...
			XLCellRange<ExcelStructsWrapper> getAsRange();
		...
		private:
			...
			bool empty( typename ExcelStructsWrapper::LPXLOPERX oper );

			typename ExcelStructsWrapper::LPXLOPERX oper, original_oper;
			typename ExcelStructsWrapper::XLOPERX _oper;
