...
namespace jedox {
	namespace palo{
		...
		public:
			~JedoxXLHelper();
			ServerSPtr getServer(const std::string& host, const unsigned int port, const std::string& user, const std::string& password, std::string& key, jedox::palo::ServerProtocol protocol = jedox::palo::Http);
