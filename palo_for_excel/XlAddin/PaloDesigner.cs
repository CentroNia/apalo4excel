...
using Jedox.Palo.XlAddin.Forms.Controls;
using Jedox.Palo.XlAddin.Utils;

namespace Jedox.Palo.XlAddin.Forms
    {
    [ComVisible(false)] 
    public partial class PaloDesigner : Form
        {
        #region TabTagObject
        ...
        private CDNM.Controls.Node StartNode;
        private CDNM.Controls.Node TargetNode;
        private int formX;
        private int formY;
        ...
        private CDNM.Controls.Node currElementNode;
        private CDNM.Controls.Node cElementNode;
        ...
        public PaloDesigner(CultureInfo originalCulture)
        {
            InitializeComponent();
        ...
        private void setSizes()
        {
            ...
            this.formX = this.tabSettings.Width;
            this.formY = this.tabSettings.Height;
            ...
            this.treeViewDims.Width = this.formX / 2 - 42;
            ...
            this.treeElements.Height = this.treeViewDims.Height + vSpace;
            ...
            this.btnClose.Left = this.treeSourceElements.Right - this.btnClose.Width;
        ...
        {
            if( Jedox.Palo.XlAddin.Connect.WizardForm == null )
            {
                // show main form
                Jedox.Palo.XlAddin.Connect.WizardForm = new Jedox.Palo.XlAddin.Forms.PaloWizard();
                Jedox.Palo.XlAddin.Connect.WizardForm.Tag = "Database Wizard Window";
            }

            Jedox.Palo.XlAddin.Connect.WizardForm.ShowDialog();
            refreshCombo();
        }
        ...
        private bool NoElements(CDNM.Controls.TreeControl tc)
        {
        ...
        private void pumpDbData()
        {
            try
            {
                ...
                for (int i = 0; i < dbDims.Length; i++)
                {
                    ...
                    tmpTab = new CDNM.Controls.TabPage(Dim);
        ...
        private void CloseBtnToPage(CDNM.Controls.TabPage tP, bool setCancel)
        {
        ...
        private void initElementsTab(CDNM.Controls.TabPage tP)
        {
            try
            {
        ...
        private void showHitElements(ref CDNM.Controls.TreeControl t)
        {
            t.Nodes.Clear();
            t.ImageList = null;
            JNode tN = new JNode();
        ...
        private void CheckIfCElementsEmpty()
        {
            ...
            for (int i = 0; i < elems.Length; i++)
            {
                ...
                if (d.Type == DimElementType.DimElementTypeConsolidated)
                {
                    ...
                    {
                        currConn.DimensionAddOrUpdateDimElement(currDb, currDimension, d.Name, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeUpdate, DimElementType.DimElementTypeNumeric, new ConsolidationInfo[] { }, false);
                        do_ping = true;
                    }
                }
            }
        ...
        private void delElement()
        {
            ...
            else
            {
                    ...
                    && this.treeElements.SelectedNode.Index != -1)
                {
                    ...
                    //foreach(CDNM.Controls.Node t in this.treeElements.SelectedNodes)
                    ...
                    if (MessageBox.Show(ResourceInitializer.Replace(ResourceInitializer.TEXT_DELETE_ELEMENTS, new object[] { strSelectedNodesString }), ResourceInitializer.TEXT_DELETE_ELEMENTS_TITLE, MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.OK)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                CDNM.Controls.Node t = (CDNM.Controls.Node)tC[i];
                                elements[i] = t.Text;
                            }
        ...
        private void editElement()
        {
            ...
            if (this.treeElements.SelectedNode != null && this.treeElements.Nodes.Count > 1)
            {
                ...
                {
                    CDNM.Controls.Node t = (CDNM.Controls.Node)this.treeElements.Nodes[i];
                    t.ForeColor = Color.Black;
                ...
                this.cTab = this.tabMain.SelectedTab;
                ...
                this.cElementNode = (CDNM.Controls.Node)((JNode)this.treeElements.SelectedNode).Clone();
        ...
        private void cmdElementMoveBegin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CDNM.Controls.Node[] tNs = new CDNM.Controls.Node[numberSelected];

                for (int i = 0; i < numberSelected; i++)
                {
                    Inds[i] = this.treeElements.SelectedNodes[i].Index;
                    CDNM.Controls.Node tN = (CDNM.Controls.Node)((JNode)this.treeElements.SelectedNodes[i]).Clone();
                    tNs[i] = tN;
                }
                ...
                for (int i = 0; i < numberSelected; i++)
                {
                    ...
                    this.treeElements.Nodes[i].Select(true);
                }                          
            }
        ...
        private void cmdElementMoveEnd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < numberSelected; i++)
                {
                    ...
                    this.treeElements.Nodes[numberExistent - i - 1].Select(true);
                }
            }
            catch (PaloException pec)
            {
        ...
        private void btnCopy_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    CDNM.Controls.Node n = treeElements.Nodes[i];
                    if (n.IsSelected)
                        tmpSN.Add(n);
                }
            ...
            if (this.cElementNode == null)
            {
                if (this.treeElements.SelectedNode != null)
                {
                    try
                    {
                        ...
                        {
                            Inds[i] = this.treeElements.SelectedNodes[i].Index;
                            tNs[i] = (CDNM.Controls.Node)((JNode)this.treeElements.SelectedNodes[i]).Clone(); ;
                        ...
                        for (int i = 0; i < numberSelected; i++)
                        {
                            ...
                            this.treeElements.Nodes[Inds[i] - 1].Select(true);
                        }
        ...
        private void cmdShowParents_Click(object sender, System.EventArgs e)
        {
            ...
            if (this.cElementNode == null)
            {
                if (this.treeElements.SelectedNode != null && this.treeElements.Nodes[0].Text != GetHitLabelText())
                {
                    try
                    {
                        DimElementInfo2 ei = this.currConn.ElementInformation(this.currDb, this.currDimension, this.treeElements.SelectedNode.Text);
        ...
        private void activateElementNode(String element)
        {
            ...
            Crownwood.DotNetMagic.Controls.Node node;
        ...
        private void btnElementCancelChanges_Click(object sender, System.EventArgs e)
        {
            ...
            for(int i=0; i< this.treeElements.Nodes.Count; i++)
            {
                CDNM.Controls.Node t = this.treeElements.Nodes[i];
        ...
        private void btnElementApplyChanges_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if(counter == 0)
                {
                    this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, this.cElementNode.Text);
                    this.currConn.Ping();
                    Connect.changesMade = true;
                }
                else
                {
                    try
                    {
                        this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, this.cElementNode.Text, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, ci, false);
                        this.currConn.Ping();
                        Connect.changesMade = true;
                    }
        ...
        public void showElements(bool tree, ref Crownwood.DotNetMagic.Controls.TreeControl treeCtrl)
        {
            ...
            for(i=0;i<tmpNodesCnt;i++)
            {
                if((treeCtrl.Nodes[i].Text == selectedNodeText) && (treeCtrl.Nodes[i] != null))
                {
                    try
                    {
                        treeCtrl.Nodes[i].Select();
                        if (treeCtrl.Nodes.Contains(treeCtrl.Nodes[i]))
                        {
                            treeCtrl.SelectedNode = treeCtrl.Nodes[i];
                        }

                        if(treeCtrl.Nodes[i].IsSelected == true)
                        {
                            treeCtrl.Nodes[i].Visible = true;
                            treeCtrl.EnsureDisplayed(treeCtrl.Nodes[i]);
                        }
                    }
                    catch
                    {}
                ...
                {
                    this.ActivateNode(treeCtrl.Nodes[i], selectedNodeText);
                }
            }
        }

        private void ActivateNode(CDNM.Controls.Node tN, string selectedNodeText)
        {
            for(int i=0;i<tN.Nodes.Count;i++)
            {
                CDNM.Controls.Node t = (CDNM.Controls.Node)tN.Nodes[i];
        ...
        private void chkTree_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            if (!this.chkTree.Checked)
            {
                ...
                this.setSizes();
                this.treeElements.AfterLabelEdit += new CDNM.Controls.LabelEditEventHandler(this.treeElements_AfterLabelEdit);
                this.treeElements.MouseUp += new System.Windows.Forms.MouseEventHandler(this.treeElements_MouseUp);
                this.treeElements.DoubleClick += new System.EventHandler(this.treeElements_DoubleClick);
                this.treeElements.KeyDown += new System.Windows.Forms.KeyEventHandler(this.treeElements_KeyDown);
                this.treeElements.AllowDrop = false;
                this.treeElements.NodeDragOver -=new Crownwood.DotNetMagic.Controls.NodeDragDropEventHandler(treeElements_NodeDragOver);
                this.treeElements.NodeDragDrop -=new Crownwood.DotNetMagic.Controls.NodeDragDropEventHandler(treeElements_NodeDragDrop);
                this.treeElements.NodeDrag -=new Crownwood.DotNetMagic.Controls.StartDragEventHandler(treeElements_NodeDrag);
        ...
        private void treeElements_AfterLabelEdit(CDNM.Controls.TreeControl sender, CDNM.Controls.LabelEditEventArgs e)
        {
            string tN = "";
            ...
            if (!DontExcuteAfterLabelEdit && (e.Node.Text != null))
            {
                ...
                if( this.nfoAddElement == true)
                {
                    ...
                    try
                    {
                        ...
                        this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, tN, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeForceAdd, etype, new ConsolidationInfo[] { }, false);
        ...
        private void treeElements_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            {// handle CTRL + A
                if (e.KeyValue == (int)System.Windows.Forms.Keys.A)
                {
                    ...
                    for(int i=0; i<this.treeElements.Nodes.Count; i++)
                    {
                        this.treeElements.Nodes[i].Select(false);
                    }
                }
            ...
            if (this.treeElements.SelectedNode != null && e.KeyValue == (int)System.Windows.Forms.Keys.F2)
            {
                ...
                {
                    CDNM.Controls.Node tmpNode = this.treeElements.SelectedNode;
                    this.treeElements.LabelEdit = true;
                    tmpNode.BeginEdit();
                }
            }
            ...
            if (e.KeyValue == (int)System.Windows.Forms.Keys.F3)
            {
                ...
                if (test2.Length > 0)
                {
                    Crownwood.DotNetMagic.Controls.NodeCollection Elems = this.treeElements.Nodes;
                    Crownwood.DotNetMagic.Controls.Node Element;
                    bool found = false;

                    Crownwood.DotNetMagic.Controls.Node ElementSelected = null;
                    ...
                    if (!found)
                    {
                        string mess = Jedox.Palo.XlAddin.Utils.ResourceInitializer.Replace(Jedox.Palo.XlAddin.Utils.ResourceInitializer.TEXT_NO_FURTHER_DIMELEMENT, new object[] { test });
        ...
        private void FillTreeSource()
        {
            ...
            try
            {
                CDNM.Controls.Node tmpNode = (CDNM.Controls.Node)this.treeElements.SelectedNodes[0];
        ...
        private void treeSourceElements_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            if(this.cElementNode != null)
            {
                ...
                this.treeSourceElements.PointToClient( pt );

                ListViewItem Node = this.treeSourceElements.GetItemAt( pt.X, pt.Y );
                if ( Node == null ) return;
...
//                          this.cmdFactor.Enabled = false;
        ...
        private void showFactor()
        {
            ...
            {
                Jedox.Palo.XlAddin.Forms.ConsolidationFactor cf = new Jedox.Palo.XlAddin.Forms.ConsolidationFactor();
        ...
        private void doTabMain_SelectionChanged0(Crownwood.DotNetMagic.Controls.TabPage oldPage, Crownwood.DotNetMagic.Controls.TabPage newPage, string attrDimName, int oldSelection)
        {
            if ((oldPage != (CDNM.Controls.TabPage)this.tabMain.TabPages[0]) || (this.olddim != newPage.Title))
            {
        ...
        private void tabMain_SelectionChanged(Crownwood.DotNetMagic.Controls.TabControl sender, Crownwood.DotNetMagic.Controls.TabPage oldPage, Crownwood.DotNetMagic.Controls.TabPage newPage)
        {
            ...
            if (oldPage != (CDNM.Controls.TabPage)this.tabMain.TabPages[0])
            {
            ...
            {
                CloseBtnToPage(this.tabMain.SelectedTab, this.tabMain.SelectedIndex == 0);
            }
            ...
            if (this.tabMain.SelectedIndex > 0)
            {
                ...
                if (!String.IsNullOrEmpty(this.currDb))
                {
                    ...
                    {
                        this.initElementsTab((CDNM.Controls.TabPage)this.tabMain.SelectedTab);
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            {
                                this.treeElements.ImageList = this.imgListElements;
                                this.treeElements.Nodes[0].Select(true);
                                this.treeElements.DeselectAll();
                                this.chkTree.Enabled = true;
                                this.btnEnableTree.Enabled = true;
        ...
        private void clearTabs()
        {
            ...
            {
                this.tabMain.TabPages.Remove((CDNM.Controls.TabPage)tList[i]);
            }
            tList = null;
        ...
        private void treeViewDims_DoubleClick(object sender, System.EventArgs e)
        {
            if(this.treeViewDims.SelectedNode != null && this.treeViewDims.SelectedNode.Text.Length != 0)
            {
                ...
                {
                    CDNM.Controls.TabPage tP = (CDNM.Controls.TabPage)this.tabMain.TabPages[i];
        ...
        private void btnHome_Click(object sender, System.EventArgs e)
        {
            if(this.cElementNode == null)
            {
                if (this.tabMain.TabPages.Count > 0)
                {
                    ...
                    this.tabMain.TabPages[0].Selected = true;
                }
            }
        }
        ...
        private void showHitDims()
        {
            ...
            TreeNode tN = new TreeNode(ResourceInitializer.TEXT_HIT_RETURN_VIEWDIMS);
            tN.NodeFont = this.regularFont;
            this.treeViewDims.Nodes.Add(tN);
            this.treeViewDims.Focus();
        }
        ...
        private void showHitCubes()
        {
            ...
            TreeNode tN = new TreeNode((string)ResourceInitializer.TEXT_HIT_RETURN_VIEWCUBES);
            tN.NodeFont = this.regularFont;
        ...
        private void dimFromTemplate()
        {
            if (!String.IsNullOrEmpty(this.currDb))
            {
                Jedox.Palo.XlAddin.Forms.DimTemplate dt = new Jedox.Palo.XlAddin.Forms.DimTemplate(this.currConn, this.currDb);
                if (dt.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        this.treeViewDims.Nodes.Add(new TreeNode(dim)); // new dimension in tree
                        CDNM.Controls.TabPage np = new CDNM.Controls.TabPage();
        ...
        private bool InsertTemplate(ArrayList Cells)
        {
            ...
            else
            {
                for (int i = 0; i < Cells.Count; i++)
                {
                    ...
                    if (tmpDataContent.Length != 0)
                    {
                        ...
                        try
                        {
                            this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, tmpDataContent);
                            this.currConn.Ping();
                        }
            ...
            for (int i = 0; i < Cells.Count; i++)
            {
                ...
                else if ((tmpDataType == "S") && (tmpDataContent.Length != 0))
                {
                    try
                    {
                        this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, tmpDataContent, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeString, new ConsolidationInfo[] { }, false);
                        this.currConn.Ping();
                    }
                    catch (System.Exception ex)
                    {
                ...
                else if (tmpDataType == "C" && tmpDataContent.Length != 0)
                {
                    try
                    {
                        this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, tmpDataContent, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, new ConsolidationInfo[] { }, true);
                        this.currConn.Ping();
                    }
                    catch (System.Exception ex)
                    {
            ...
            for (int i = 0; i < Cells.Count; i++)
            {
                ...
                if (tmpDataType == "C")
                {
                    try
                    {
                        ...
                        try
                        {
                            this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, tmpDataContent, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, ci, true);
                            this.currConn.Ping();
                            tmpCounter++;
                        }
                        catch(System.Exception pexc)
                ...
                )
            {
                ...
                if (MessageBox.Show(ResourceInitializer.Replace(ResourceInitializer.TEXT_DELETE_DATAAXIS, new object[] { dim }), ResourceInitializer.TEXT_DELETE_DATAAXIS_TITLE, MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.OK)
                {
                    try
                    {
                        ...
                        for(int i=1; i<this.tabMain.TabPages.Count; i++)
                        {
                            CDNM.Controls.TabPage p = (CDNM.Controls.TabPage)this.tabMain.TabPages[i];
        ...
        {
            System.Drawing.Point pt = new System.Drawing.Point( e.X, e.Y );
            this.treeViewDims.PointToClient( pt );
        ...
        {
            System.Drawing.Point pt = new System.Drawing.Point( e.X, e.Y );
            this.treeViewCubes.PointToClient( pt );
            ...
            if (Node.Parent != null)
            {
                if (e.Button == MouseButtons.Right)
                {
                    try
                    {
                        ...
                        if (!foundMeasure)
                        {
                            this.currConn.DimensionAddOrUpdateDimElement(this.currDb, "#_CONFIGURATION_", sMeasure, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeForceAdd, DimElementType.DimElementTypeString, new ConsolidationInfo[] { }, false);
                            do_ping = true;
                        }
                        // Create MDXTime_...
                        if (!foundTime)
                        {
                            this.currConn.DimensionAddOrUpdateDimElement(this.currDb, "#_CONFIGURATION_", sTime, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeForceAdd, DimElementType.DimElementTypeString, new ConsolidationInfo[] { }, false);
                            do_ping = true;
                        }
                        if (do_ping)
                        {
        ...
        private void cmdNumeric_Click(object sender, System.EventArgs e)
        {
            ...
            {
                JNode tn = (CDNM.Controls.Node)this.treeElements.SelectedNodes[0] as JNode;
                if ((string)tn.Tag == "N")
                {
                    return;
                }
            ...
            for(int i=0; i<tC.Count; i++)
            {
                JNode t = (CDNM.Controls.Node)tC[i] as JNode;
                ...
                try
                {
                    this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, t.Text, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeNumeric, new ConsolidationInfo[] { }, false);
                    this.currConn.Ping();
                    t.Tag = "N";
                    t.ImageIndex = 0;
        ...
        private void cmdString_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < tC.Count; i++)
            {
                ...
                try
                {
                    this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, t.Text, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeString, new ConsolidationInfo[] { }, false);
                    this.currConn.Ping();
                    t.Tag = "S";
                    t.ImageIndex = 1;
        ...
        private void cmdElemSelectAll_Click(object sender, System.EventArgs e)
        {
            for(int i=0; i<this.treeElements.Nodes.Count; i++)
            {
                CDNM.Controls.Node n = (CDNM.Controls.Node)this.treeElements.Nodes[i];
                n.Select(false);
            }
        }
        ...
        {
        // JMM 09-16-13 Fireball is no longer available
        #if UNUSED
            if (this.treeViewCubes.SelectedNode == null)
            {
                return;
            ...
            Jedox.Palo.XlAddin.Forms.SVSWizard ew = new SVSWizard(this.originalCulture, this.currHostname, this.currDb, this.treeViewCubes.SelectedNode.Text);
            ew.ShowDialog();
            ew.Dispose();
            ew = null;
        #endif
        ...
        private void cmdCountElements_Click(object sender, System.EventArgs e)
        {
            if (this.cElementNode == null)
            {
                ...
                else
                {
                    ...
                    {
                        JNode tn = (CDNM.Controls.Node)this.treeElements.Nodes[i] as JNode;
        ...
        private void cmdTabDim_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < this.tabMain.TabPages.Count; i++)
            {
                CDNM.Controls.TabPage tP = this.tabMain.TabPages[i];
        ...
        private static bool TestExistingElements(ref CDNM.Controls.TreeControl tw, CDNM.Controls.Node data)
        {
            bool ret = false;
            //foreach(CDNM.Controls.Node t in tw.Nodes)
            for(int i=0;i<tw.Nodes.Count;i++)
            {
                CDNM.Controls.Node t = (CDNM.Controls.Node)tw.Nodes[i];
        ...
        private static bool TestExistingElements(ref CDNM.Controls.TreeControl tw, Array data)
        {
            bool ret = false;
            //foreach(CDNM.Controls.Node t in tw.Nodes)
            for(int i=0;i<tw.Nodes.Count;i++)
        ...
        private static bool TestExistingElements(ref CDNM.Controls.TreeControl tw, out CDNM.Controls.Node tn, Array data)
        {
            bool ret = false;
            tn = null;
//          foreach(TreeNode t in tw.Nodes)
        ...
        private void CopyToClipboard(ArrayList Cells)
        {
            ...
            for(int i=0;i<Cells.Count;i++)
            {
                JNode t = (CDNM.Controls.Node)Cells[i] as JNode;
                if(t.Tag.ToString() != "C")
                {
        ...
        private bool InsertClipBoard(ArrayList Cells, uint MovePos, CDNM.Controls.TreeControl tw)
        {
            ...
            if(testContent.LongLength > 1)
            {
                ...
                try
                {
                    ...
                    for(int i=0;i<tmpElems.Length;i++)
                    {
                        ...
                        {
                            this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, name, DimElementType.DimElementTypeNumeric, new ConsolidationInfo[] { });
                        }
                    }
                    this.currConn.Ping();
                    this.treeElements.Nodes.Clear();
            ...
            for(int i=0;i<Cells.Count;i++)
            {
                ...
                {       
                    ...
                    try
                    {
                        this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, (string)tn.Text);
                        this.currConn.Ping();
                        tw.Nodes.Add(tn);
                    }
                    catch
                ...
                else if(tmpDataType == "S" && tmpDataContent.Length != 0)
                {
                    ...
                    try
                    {
                        this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, (string)tn.Text, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeString, new ConsolidationInfo[] { }, false);
                        this.currConn.Ping();
                        tw.Nodes.Add(tn);
                    }
                    catch
                ...
                else if(tmpDataType == "C" && tmpDataContent.Length != 0)
                {
                    ...
                    try
                    {
                        this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, (string)tn.Text, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, new ConsolidationInfo[] { }, true);
                        this.currConn.Ping();
                        tw.Nodes.Add(tn);
                    }
                    catch
        ...
        private void treeElements_NodeDragOver(Crownwood.DotNetMagic.Controls.TreeControl tc, Crownwood.DotNetMagic.Controls.Node n, DragEventArgs e)
        {
            if((System.Windows.Forms.Control.ModifierKeys & Keys.Control) == Keys.Control)
        ...
        private void treeElements_NodeDrag(Crownwood.DotNetMagic.Controls.TreeControl tc, Crownwood.DotNetMagic.Controls.StartDragEventArgs e)
        {
            StartNode = e.Node;
        }

        // Finish dragging - do the actual move
        private void treeElements_NodeDragDrop(Crownwood.DotNetMagic.Controls.TreeControl tc, Crownwood.DotNetMagic.Controls.Node n, DragEventArgs e)
        {
            #region Exit if empty or same
            ...
            else
            {
                ...
                try
                {
                    ...
                    this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, tParent, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, nci, false);
                    this.currConn.Ping();
                        ...
                        && (System.Windows.Forms.Control.ModifierKeys & Keys.Control) != Keys.Control)
                    {
                            ...
                            this.currConn.ElementParentCount(this.currDb, this.currDimension, this.StartNode.Text) != 0)
                        {
                            ...
                            try
                            {
                                this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, sParent, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, nci, false);
                                this.currConn.Ping();
                            }
                            catch(PaloException excDau)
                            {
                ...
                for(int i=0;i<this.treeElements.Nodes.Count;i++)
                {
                    CDNM.Controls.Node tmpNode = (CDNM.Controls.Node)this.treeElements.Nodes[i];
                    if(!tmpHt.ContainsKey(tmpNode.FullPath))
                        tmpHt.Add(tmpNode.FullPath, tmpNode.Expanded);
                ...
                CDNM.Controls.NodeCollection tmpTc = (CDNM.Controls.NodeCollection)/*this.treeElements.Nodes.Clone();*/
                                                     JNode.CloneCollection(this.treeElements.Nodes);
            }
        ...
        private void DoChildrenExpand(CDNM.Controls.Node n, Hashtable ht)
        {
            for(int i=0;i<n.Nodes.Count;i++)
            {
                CDNM.Controls.Node tN = (CDNM.Controls.Node)n.Nodes[i];
        ...
        private void DoChildren(CDNM.Controls.Node n, ref Hashtable ht)
        {
            for(int i=0;i<n.Nodes.Count;i++)
            {
                CDNM.Controls.Node tN = (CDNM.Controls.Node)n.Nodes[i];
                if(!ht.ContainsKey(tN.FullPath))
                    ht.Add(tN.FullPath, tN.Expanded);
        ...
        private void cmdChild_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (cntUnique == 0)
                {
                    this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, this.TargetNode.Text, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, nci, false);
                    this.currConn.Ping();
                }
            ...
            for(int i=0;i<this.treeElements.Nodes.Count;i++)
            {
                CDNM.Controls.Node tmpN = this.treeElements.Nodes[i];
        ...
        private void cmdSibling_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // add it to the new C element
                    this.currConn.DimensionAddOrUpdateDimElement(this.currDb, this.currDimension, ElementToChange, DimensionAddOrUpdateElementMode.DimensionAddOrUpdateElementModeAddOrUpdate, DimElementType.DimElementTypeConsolidated, nci, false);
                    this.currConn.Ping();
                }
                else
                {
            ...
            for (int i = 0; i < this.treeElements.Nodes.Count; i++)
            {
                CDNM.Controls.Node n = this.treeElements.Nodes[i];
        ...
        private void prepare_collaps(Crownwood.DotNetMagic.Controls.NodeCollection nodes, int level)
        {
        ...
        private void do_collaps(Crownwood.DotNetMagic.Controls.NodeCollection nodes, int level)
        {
            int cntElems = nodes.Count;
            for(int i=0;i<cntElems;i++)
            {
        ...
        private void do_expand(Crownwood.DotNetMagic.Controls.NodeCollection nodes)
        {
            int cntElems = nodes.Count;
            for(int i=0;i<cntElems;i++)
            {
        ...
        private void do_special_selection(Crownwood.DotNetMagic.Controls.NodeCollection nodes, int level, int expected_level, Crownwood.DotNetMagic.Controls.NodeCollection orig)
        {
            int cntElems = nodes.Count;
            for(int i=0;i<cntElems;i++)
            {
        ...
        private void sortDims(bool reverse)
        {
            ...
            for (int i = 0; i < maxitem; i++)
            {
                ...
                CDNM.Controls.TabPage tmpTab = new CDNM.Controls.TabPage(sDims[i]);
                tmpTab.Title = tmpTab.Title.Replace("&", "&&");
        ...
        {
            int maxitem = this.treeElements.Nodes.Count;
            CDNM.Controls.Node[] elems = new CDNM.Controls.Node[maxitem];
            string selectedElem = "";
            for (int i = 0; i < maxitem; i++)
            {
                elems[i] = this.treeElements.Nodes[i];
                if (this.treeElements.Nodes[i].IsSelected)
                {
            ...
            for (int i = 0; i < maxitem; i++)
            {
                this.treeElements.Nodes.Add(elems[i]);
        ...
        private static int CompareNodes(CDNM.Controls.Node n1, CDNM.Controls.Node n2)
        {
        ...
        private void cmdSearchElements_Click(object sender, EventArgs e)
        {
            ...
            if (se.ShowDialog() == DialogResult.OK)
            {
                ...
                if (test2.Length > 0)
                {
                    ...
                    if (!found)
                    {
                        string mess = Jedox.Palo.XlAddin.Utils.ResourceInitializer.Replace(Jedox.Palo.XlAddin.Utils.ResourceInitializer.TEXT_DIMELEMENT_NOT_FOUND, new object[] { test, this.currDimension });
                        System.Windows.Forms.MessageBox.Show(mess);
                    }
                }
            }
