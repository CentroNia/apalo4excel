...
{
    public enum PRadioPanelType { Bool, Int };

    public class PRadioPanel : Panel, IPrimitive
    {
        ...
        private PRadioPanelType pRadioPanelType = PRadioPanelType.Bool;
        public PRadioPanelType PRadioPanelType
        {
            get { return pRadioPanelType; }
            set { pRadioPanelType = value; }
        }
        ...
        public string SValue
        {
            get
            {
                if (this.PRadioPanelType == PRadioPanelType.Bool)
                {
                    if (!this.Inverse)
