...
{
    public partial class PCombo : ComboBox, IPrimitive
    {
        ...
        public string SValue
        {
            get
            {
                ...
                return (this.hardSelectedIndex + startCount).ToString();
            }
            set
            {
                try
                {
                    this.SelectedIndex = int.Parse(value) - startCount;
                }
                catch
                {
                    this.SetDefault();
        ...
        public bool SetCtrlFromXml(System.Xml.XmlNode root)
        {
            try
            {
                this.SValue = root.ChildNodes[0].Value;
            }
            catch
            {
                this.SetDefault();
