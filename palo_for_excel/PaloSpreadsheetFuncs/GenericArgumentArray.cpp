...
GenericArgumentArray::GenericArgumentArray( std::vector<GenericCell*>& _args ) : args(_args), connection_fixed(false) {}
...
void GenericArgumentArray::fixConnection( ConnectionPool& cp, unsigned int idx ) {
