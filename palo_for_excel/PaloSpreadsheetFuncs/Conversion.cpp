...
namespace jedox {
	namespace i18n {
		...
		ConversionException::ConversionException( const char * message ) : std::runtime_error( message ) {}

		//////////////////////////////////////////////////////////////////////////
		//////////////////////////////////////////////////////////////////////////

		Conversion::Conversion( const internal::Converter& from, const internal::Converter& to ) : m_ConvertFrom( from ), m_ConvertTo( to ) {}
