	...
	namespace SpreadsheetFuncs {
		...
		public:
			...
			*/
			 ...
			 *  What the name suggests.
			 */
			virtual StringArrayArray getStringArrayArray();

			/*! \brief Retrieve an argument.
			 *
			 *  What the name suggests.
			 */
			virtual boost::shared_ptr<jedox::palo::Server> getConnection( ConnectionPool& cp );
			 ...
			 *  What the name suggests.
			 */
			virtual GenericCell& set( const CellValueWithProperties& v, bool set_error_desc = true);
		...
		protected:
			 ...
			 *  What the name suggests.
			 */
			virtual void setPropValues(const std::vector<std::string>& PropValues ) {
			};
