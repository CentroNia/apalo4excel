...
namespace Palo {
	namespace SpreadsheetFuncs {
		...
		public:
			GenericCellIteratorImpl() : ref_count( 0 ) {}
		...
		public:
			GenericCellIterator( GenericCellIteratorImpl* iter ) : real_iter( iter ) {
				real_iter->addRef();
			}

			GenericCellIterator( const GenericCellIterator& other ) : real_iter( other.real_iter ) {
				real_iter->addRef();
			}
