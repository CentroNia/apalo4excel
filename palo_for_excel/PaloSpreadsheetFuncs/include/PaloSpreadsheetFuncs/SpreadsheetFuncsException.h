...
namespace Palo {
	namespace Types {
		 ...
		 */
		class SpreadsheetFuncsException : public CPException {
		public:
			SpreadsheetFuncsException( const SourceLocation& loc, SpreadsheetFuncsErrors::Errors e ) : CPException( loc, SpreadsheetFuncsMessages::getInstance()[e] ) {}
