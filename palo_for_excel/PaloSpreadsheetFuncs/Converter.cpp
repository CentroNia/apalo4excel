/**
*  \file
*  Copyright (C) 2006-2011 Jedox AG, Freiburg i.Br., Germany
* 
...
namespace jedox {
	namespace i18n {
		...
		ConverterException::ConverterException( const char * message ) : std::runtime_error( message ) {}

		//////////////////////////////////////////////////////////////////////////
		//////////////////////////////////////////////////////////////////////////

		namespace internal {
			Converter::Converter() : m_Converter( NULL ) {
				init();
			}

			Converter::Converter( const std::string& lang ) : m_Converter( NULL ) {
				init( lang.c_str() );
			}

			Converter::Converter( const Converter& other ) : m_Converter( NULL ) {
			...
			ConverterUTF8::ConverterUTF8() : Converter( "UTF8" ) {}
		}						 /* namespace internal */
