...
GenericCellCellSerializer::GenericCellCellSerializer( GenericCell& gc ) : a( gc.setArray( 0, false ) ) {}
...
GenericCellCellDeserializer::GenericCellCellDeserializer( GenericCell& gc ) : iter( gc.getArray() ), got( false ), inc( false ) {}
