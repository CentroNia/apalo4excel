...
boost::shared_ptr<jedox::palo::Server> DummyCell::getConnection( ConnectionPool& cp, std::string& database ) {
	throw InvalidRequestException( CurrentSourceLocation );
}
...
StringCell::StringCell( const std::string& s ) : s( s ) {}
...
ConnectionCell::ConnectionCell( boost::shared_ptr<jedox::palo::Server> s ) : s( s ) {}

ConnectionCell::~ConnectionCell() {}

boost::shared_ptr<jedox::palo::Server> ConnectionCell::getConnection( ConnectionPool& cp, std::string& database ) {
	return s;
}
...
ArrayCellIteratorImpl::ArrayCellIteratorImpl( ArrayCell& a ) : a( a ), pos( 0 ) {}
