			...
			static StringArray GetdataVParseStringArray( GenericCell::Iterator& i, size_t& pad_count, size_t& tail_padding ) {
				...
				while ( true ) {
					if ( !i.end() && i->empty() ) {
						...
						if (( _last_pad_count != _pad_count && _last_pad_count != -1 ) && !( i.end() && _pad_count > _last_pad_count ) )
							throw ArgumentException( CurrentSourceLocation, SpreadsheetFuncsErrors::ERROR_INVALID_ARGUMENT_FORMAT );

						if ( i.end() ) {
							if ( _last_pad_count != -1 ) {
								// >=0
...
SpreadsheetFuncs::SpreadsheetFuncs( ConnectionPool& cp ) : SpreadsheetFuncsBase( cp ) {}
...
void SpreadsheetFuncs::FPaloInit( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ((arg_length > 4) && !arg[4].isMissing()) {
		forcecheck = arg[4].getBool();
	}

	retval.set( SpreadsheetFuncsBase::FPaloInit( arg[0], ( unsigned short int )arg[1].getUInt(), arg[2].getString(), arg[3].getString(), forcecheck ) );
}

void SpreadsheetFuncs::FPaloDisconnect( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.checkArgCount( 1 );
	arg[0].set(( jedox::palo::Server* )NULL );
}
...
void SpreadsheetFuncs::FPaloRegisterServer( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg_length == 6 ){
		// void
		retval.set( SpreadsheetFuncsBase::FPaloRegisterServer( arg[0].getString(), arg[1].getString(), arg[2].getUInt(), arg[3].getString(), arg[4].getString(), arg[5].getBool() ) );
	} else if ( arg_length == 5 ) {
		// void
		if (arg[4].getType() == GenericCell::TBool  ) {
			retval.set( SpreadsheetFuncsBase::FPaloRegisterServer( arg[0].getString(), arg[1].getString(), arg[2].getUInt(), arg[3].getString(), arg[4].getBool() ) );
		} else {
			retval.set( SpreadsheetFuncsBase::FPaloRegisterServer( arg[0].getString(), arg[1].getString(), arg[2].getUInt(), arg[3].getString(), arg[4].getString() ) );
		}
...
void SpreadsheetFuncs::FPaloPing( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.checkArgCount( 1 );
	retval.set( SpreadsheetFuncsBase::FPaloPing( arg[0].getConnection( cp ) ) );
}
...
void SpreadsheetFuncs::FPaloServerInfo( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.checkArgCount( 1 );
	retval.set( SpreadsheetFuncsBase::FPaloServerInfo( arg[0].getConnection( cp ) ) );
}
...
void SpreadsheetFuncs::FPaloLicenseInfo( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.checkArgCount( 1 );
	retval.set( SpreadsheetFuncsBase::FPaloLicenseInfo( arg[0].getConnection( cp ) ) );
}

void SpreadsheetFuncs::FPaloChangePassword( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.checkArgCount( 3 );
	SpreadsheetFuncsBase::FPaloChangePassword( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloCubeClear( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.fixConnection( cp, 0 );

	switch (arg.length()) {
		case 3:
			SpreadsheetFuncsBase::FPaloCubeClear( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() );
			break;

		case 4:
			SpreadsheetFuncsBase::FPaloCubeClear( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getElementListArray() );
			break;
...
void SpreadsheetFuncs::FPaloDimensionClear( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.checkArgCount( 3 );
	// void
	SpreadsheetFuncsBase::FPaloDimensionClear( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloRootAddDatabase( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if (arglen == 2) {
		SpreadsheetFuncsBase::FPaloRootAddDatabase( arg[0].getConnection( cp ), arg[1].getString() );
	} else if ( arglen == 3) {
		SpreadsheetFuncsBase::FPaloRootAddDatabase( arg[0].getConnection( cp ), arg[1].getString(),  jedox::palo::DATABASE_INFO::TYPE(arg[2].getUInt()) );
	} else {
		throw WrongParamCountException( CurrentSourceLocation );
	}
	retval.set( true );
...
void SpreadsheetFuncs::FPaloRootDeleteDatabase( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 2 );
	retval.set( SpreadsheetFuncsBase::FPaloRootDeleteDatabase( arg[0].getConnection( cp ), arg[1].getString() ) );
}
...
void SpreadsheetFuncs::FPaloDatabaseAddCube( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.checkArgCount( 4 );
	// void
	SpreadsheetFuncsBase::FPaloDatabaseAddCube( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloDatabaseAddDimension( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.checkArgCount( 3 );
	// void
	SpreadsheetFuncsBase::FPaloDatabaseAddDimension( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloDatabaseDeleteCube( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloDatabaseDeleteCube( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloDatabaseDeleteDimension( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloDatabaseDeleteDimension( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloDatabaseLoadCube( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloDatabaseLoadCube( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloDatabaseUnloadCube( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloDatabaseUnloadCube( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloElementListConsolidationElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		retval.set( SpreadsheetFuncsBase::FPaloElementListConsolidationElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
}
...
void SpreadsheetFuncs::FPaloDimensionTopElementsCount( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	retval.set( SpreadsheetFuncsBase::FPaloDimensionTopElementsCount( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloDimensionSimpleFlatListElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length()) {
		case 3:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleFlatListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
			break;

		case 4:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleFlatListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong()) );
			break;

		case 5:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleFlatListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong() ) );
			break;
...
void SpreadsheetFuncs::FPaloDimensionSimpleTopListElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length()) {
		case 3:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleTopListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
			break;

		case 4:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleTopListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong()) );
			break;

		case 5:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleTopListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong() ) );
			break;
...
void SpreadsheetFuncs::FPaloDimensionSimpleChildrenListElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length()) {
		case 4:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleChildrenListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong() ) );
			break;

		case 5:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleChildrenListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong()) );
			break;

		case 6:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionSimpleChildrenListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong(), arg[5].getSLong() ) );
			break;
...
void SpreadsheetFuncs::FPaloDimensionReducedFlatListElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length()) {
		case 3:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedFlatListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
			break;

		case 4:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedFlatListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong()) );
			break;

		case 5:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedFlatListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong() ) );
			break;
...
void SpreadsheetFuncs::FPaloDimensionReducedTopListElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length()) {
		case 3:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedTopListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
			break;

		case 4:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedTopListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong()) );
			break;

		case 5:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedTopListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong() ) );
			break;
...
void SpreadsheetFuncs::FPaloDimensionReducedChildrenListElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length()) {
		case 4:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedChildrenListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong() ) );
			break;

		case 5:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedChildrenListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong()) );
			break;

		case 6:
			retval.set( *SpreadsheetFuncsBase::FPaloDimensionReducedChildrenListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getSLong(), arg[5].getSLong() ) );
			break;
...
void SpreadsheetFuncs::FPaloDimensionListElements2( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	retval.set( *SpreadsheetFuncsBase::FPaloDimensionListElements2( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), filter ) );
}
...
void SpreadsheetFuncs::FPaloDimensionListElements( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	retval.set( SpreadsheetFuncsBase::FPaloDimensionListElements( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), filter ) );
...
void SpreadsheetFuncs::FPaloDimensionListCubes( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloDimensionListCubes( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloCubeListDimensions( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloCubeListDimensions( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloDatabaseListCubes( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( (arg.length() == 2) ||  ((arg.length() > 2) && arg[2].isMissing())) {
		retval.set( SpreadsheetFuncsBase::FPaloDatabaseListCubes( arg[0].getConnection( cp ), arg[1].getString() ) );
		...
		retval.set( SpreadsheetFuncsBase::FPaloDatabaseListCubes( arg[0].getConnection( cp ), arg[1].getString(), type ) );
	} else {
		throw WrongParamCountException( CurrentSourceLocation );
	}
}
...
void SpreadsheetFuncs::FPaloDatabaseListDimensions( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( (len == 2) || ((len == 3) && arg[2].empty()) ) {
		retval.set( SpreadsheetFuncsBase::FPaloDatabaseListDimensions( arg[0].getConnection( cp ), arg[1].getString() ) );
	} else if ( len == 3 ) {
		...
		retval.set( SpreadsheetFuncsBase::FPaloDatabaseListDimensions( arg[0].getConnection( cp ), arg[1].getString(), type ) );
	} else {
		throw WrongParamCountException( CurrentSourceLocation );
	}
}
...
void SpreadsheetFuncs::FPaloRootListDatabases( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	if ( arg.length() == 1 )
		retval.set( SpreadsheetFuncsBase::FPaloRootListDatabases( arg[0].getConnection( cp ), false, false ) );
	else if ( arg.length() == 2 )
		retval.set( SpreadsheetFuncsBase::FPaloRootListDatabases( arg[0].getConnection( cp ), arg[1].getBool(), false ) );
	else if ( arg.length() == 3 )
		retval.set( SpreadsheetFuncsBase::FPaloRootListDatabases( arg[0].getConnection( cp ), arg[1].getBool(), arg[2].getBool() ) );
	else
		throw WrongParamCountException( CurrentSourceLocation );
}
...
void SpreadsheetFuncs::FPaloDatabaseRenameDimension( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.checkArgCount( 4 );
	// void
	SpreadsheetFuncsBase::FPaloDatabaseRenameDimension( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloCubeRename( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.checkArgCount( 4 );
	// void
	SpreadsheetFuncsBase::FPaloCubeRename( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloDimensionInfo( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloDimensionInfo( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloCubeInfo( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.checkArgCount( 3 );
	// void	
	retval.set( SpreadsheetFuncsBase::FPaloCubeInfo( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}

void SpreadsheetFuncs::FPaloSetdataA( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.fixConnection( cp, 2 );
	arg.checkArgCount( 6 );
	if ( arg[3].empty(false) ) {
		retval.setEmpty();
	} else {
		retval.set( SpreadsheetFuncsBase::FPaloSetdata( arg[2].getConnection( cp ), arg[3].getString(), arg[4].getString(), arg[5].getStringArray(), arg[0].getCellValue(), opts.splashingAllowed() ? arg[1].getSplashMode() : jedox::palo::MODE_SPLASH_NONE ) ); 
	}
}
...
void SpreadsheetFuncs::FPaloSetdataBulk( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg.length() == 6 || arg.length() == 5 ) {
		if ( arg[3].empty(false) ) {
			...
			retval.set( SpreadsheetFuncsBase::FPaloSetdataBulk( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArrayArray(), arg[4].getCellValueArray(), opts.splashingAllowed() ? ( arg.length() == 6 ? arg[5].getSplashMode() : jedox::palo::MODE_SPLASH_DEFAULT ) : jedox::palo::MODE_SPLASH_NONE ) );
		}
	} else {
		throw WrongParamCountException( CurrentSourceLocation );
	}
...
void SpreadsheetFuncs::FPaloGetdataA( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) ) {
		...
		retval.set( SpreadsheetFuncsBase::FPaloGetdata( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray() ) ); 
	}
}

void SpreadsheetFuncs::FPaloSetdataAIf( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.fixConnection( cp, 3 );
	if ( arg.length() < 7 ) {
		throw WrongParamCountException( CurrentSourceLocation );
	}
	...
	if( !arg[0].getBool() ) {
		...
		if ( arg[4].empty(false) ) {
			...
			retval.set( SpreadsheetFuncsBase::FPaloSetdata( arg[3].getConnection( cp ), arg[4].getString(), arg[5].getString(), arg[6].getStringArray(), arg[1].getCellValue(), opts.splashingAllowed() ? arg[2].getSplashMode() : jedox::palo::MODE_SPLASH_NONE ) );
		}
	}
}
...
void SpreadsheetFuncs::FPaloGetdataAV( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	*_vals = SpreadsheetFuncsBase::FPaloGetdataV( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), a.coords );
	...
	for ( size_t i = 0; i < num_coordinates - 1; i++ ) {
		for ( size_t j = i + 1; j < num_coordinates; j++ ) {
			if ( a.info[a.idx_map[i].cube_idx].is_vertical == a.info[a.idx_map[j].cube_idx].is_vertical
				&& a.idx_map[i].pad_count > a.idx_map[j].pad_count ) {
					/* swap */
...
void SpreadsheetFuncs::FPaloGetdataAT( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) ) {
		...
		GetdataHelper::_GetdataT( retval, SpreadsheetFuncsBase::FPaloGetdata( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray() ) );
	}
}
...
void SpreadsheetFuncs::FPaloGetdataAggregation( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg, AggregationType aggregationtype ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 5 );
	retval.set( SpreadsheetFuncsBase::FPaloGetdataAggregation( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray(), aggregationtype, arg[4].getIntArray() ) ); 
}
...
void SpreadsheetFuncs::FPaloGetdataC( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.collapseToArray( 3 );
	FPaloGetdataAC( retval, opts, arg );
}
...
void SpreadsheetFuncs::FPaloCellCopy( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	retval.set(SpreadsheetFuncsBase::FPaloCellCopy(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray(), arg[4].getStringArray(), cv, use_rules ));
}
...
void SpreadsheetFuncs::FPaloGoalSeek( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	retval.set(SpreadsheetFuncsBase::FPaloGoalSeek(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray(), arg[4].getDouble(), (GoalSeekType)arg[5].getUInt(), area ));
}
...
void SpreadsheetFuncs::FPaloElementCreateBulk(Palo::SpreadsheetFuncs::GenericCell &retval, Palo::SpreadsheetFuncs::GenericContext &opts, Palo::SpreadsheetFuncs::GenericArgumentArray &arg) {
	...
	if ( arg[4].empty(false) ) {
		...
		try {
			if(arg.length() > 5) {
				SpreadsheetFuncsBase::FPaloElementCreateBulk( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray(), arg[4].getDimensionElementType(), arg[5].getStringArrayArray(), arg[6].getStringArrayArray() );
			}else{
				StringArrayArray dummy;
				SpreadsheetFuncsBase::FPaloElementCreateBulk( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray(), arg[4].getDimensionElementType(), dummy, dummy );
			}
		} catch(...) {
			if(!return_empty) {
				throw;
...
void SpreadsheetFuncs::FPaloElementAdd( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[4].empty(false) ) {
		...
		try {
			...
			retval.set( SpreadsheetFuncsBase::FPaloElementAdd( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getDimensionElementType(), arg[4].getString(), arg[5].getString(), arg[6].getDouble(), clear ) );
		} catch(...) {
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementDelete( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementDelete( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		} catch(...) {
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementDeleteBulk( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		if(arg.length() > 4 && !arg[4].isMissing())
			return_empty = arg[4].getBool();
		try {
			SpreadsheetFuncsBase::FPaloElementDeleteBulk( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getStringArray() );
			retval.set(true);
		} catch(...) {
			if(!return_empty) {
				throw;
...
void SpreadsheetFuncs::FPaloElementMove( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		// void
		SpreadsheetFuncsBase::FPaloElementMove( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getUInt() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloElementRename( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) || arg[4].empty(false) )
		...
		try {
			SpreadsheetFuncsBase::FPaloElementRename( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getString() );
			retval.set( true );
		} catch(...) {
			if(!return_empty) {
				throw;
...
void SpreadsheetFuncs::FPaloElementUpdate( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) ) {
		...
		if ((mode == 0) || (mode == 1)) {			
			SpreadsheetFuncsBase::FPaloElementUpdate( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getDimensionElementType(), arg[5].getConsolidationElementArray(), mode == 1 );			
		} else {
			if (mode == 2) {				
				SpreadsheetFuncsBase::FPaloChildrenDelete( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(),arg[5].getStringArray() );
			} else {
				throw ArgumentException( CurrentSourceLocation, SpreadsheetFuncsErrors::ERROR_INVALID_ARGUMENT_VALUE );
			}
		}		
...
void SpreadsheetFuncs::FPaloElementChildcount( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		if(arg.length() > 4 && !arg[4].isMissing())
			return_empty = arg[4].getBool();
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementChildcount( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementChildname( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementChildname( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getUInt() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementCount( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	try {	
		retval.set( SpreadsheetFuncsBase::FPaloElementCount( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
	}catch(...){
		if(!return_empty) {
			throw;
		}else{
...
void SpreadsheetFuncs::FPaloElementFirst( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	try {
		retval.set( SpreadsheetFuncsBase::FPaloElementFirst( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
	}catch(...){
		if(!return_empty) {
			throw;
		}else{
...
void SpreadsheetFuncs::FPaloElementIndex( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementIndex( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementIsChild( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) || arg[4].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementIsChild( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementLevel( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementLevel( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementIndent( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementIndent( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
	...
	if ( arg[3].empty(false) ) {
		...
		if ( arglength < 7 || ( fig < 0 ) || ( fig > 3 ) || ( fig == 1 ) || ( arglength >= 7 && arg[6].empty(false) ) ) {
			if ( arg[3].getType() == GenericCell::TDouble || arg[3].getType() == GenericCell::TInt ) {
				retval.set( SpreadsheetFuncsBase::FPaloElementName( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getUInt() ) );
			} else {
				retval.set( SpreadsheetFuncsBase::FPaloElementName( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
			}
		} else {
			retval.set( SpreadsheetFuncsBase::FPaloElementName( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[6].getString() ) ); 
		}
	}
}
...
void SpreadsheetFuncs::FPaloElementParentcount( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementParentcount( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementParentname( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementParentname( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getUInt() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementPrev( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementPrev( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementListParents( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementListParents( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementListSiblings( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		if(arg.length() > 4 && !arg[4].isMissing())
			return_empty = arg[4].getBool();
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementListSiblings( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString()) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementListAncestors( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementListAncestors( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementListDescendants( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementListDescendants( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		}catch(...){
			if(!return_empty) {
				throw;
			}else{
...
void SpreadsheetFuncs::FPaloElementNext( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) ) {
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementNext( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		} catch (...) {
			if (!return_empty)
				throw;
			else
...
void SpreadsheetFuncs::FPaloElementSibling( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementSibling( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getSInt() ) );
		} catch (...) {
			if (!return_empty)
				throw;
			else
...
void SpreadsheetFuncs::FPaloDimensionMaxLevel( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloDimensionMaxLevel( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloElementType( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementType( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
		} catch (...) {
			if (!return_empty)
				throw;
			else
...
void SpreadsheetFuncs::FPaloElementWeight( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg[3].empty(false) || arg[4].empty(false) )
		...
		try {
			retval.set( SpreadsheetFuncsBase::FPaloElementWeight( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getString() ) );
		}	catch (...) {
			if (!return_empty)
				throw;
			else
...
void SpreadsheetFuncs::FPaloEventLockBegin( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.checkArgCount( 3 );
	// void
	SpreadsheetFuncsBase::FPaloEventLockBegin( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloEventLockEnd( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	CLEAR_ERRORINFO
	arg.checkArgCount( 1 );
	SpreadsheetFuncsBase::FPaloEventLockEnd( arg[0].getConnection( cp ) );
	retval.set( true );
}
...
void SpreadsheetFuncs::FPaloCubeRuleCreate( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length() ) {
		case 4:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleCreate( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
			break;

		case 5:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleCreate( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getString() ) );
			break;

		case 6:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleCreate( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getString(), arg[5].getString() ) );
			break;

		case 7:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleCreate( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getString(), arg[5].getString(), arg[6].getBool() ) );
			break;
...
void SpreadsheetFuncs::FPaloCubeRuleModify( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	switch (arg.length() ) {
		case 5:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleModify( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getString() ) );
			break;

		case 6:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleModify( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getString(), arg[5].getString() ) );
			break;

		case 7:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleModify( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getString(), arg[5].getString(), arg[6].getString() ) );
			break;

		case 8:
			retval.set( SpreadsheetFuncsBase::FPaloCubeRuleModify( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong(), arg[4].getString(), arg[5].getString(), arg[6].getString(), arg[7].getBool() ) );
			break;
...
void SpreadsheetFuncs::FPaloCubeRuleParse( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 4 );
	retval.set( SpreadsheetFuncsBase::FPaloCubeRuleParse( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString() ) );
}
...
void SpreadsheetFuncs::FPaloCubeRuleDelete( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 4 );
	retval.set( SpreadsheetFuncsBase::FPaloCubeRuleDelete( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong() ) );
}
...
void SpreadsheetFuncs::FPaloCubeRules( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	arg.fixConnection( cp, 0 );
	arg.checkArgCount( 3 );
	retval.set( SpreadsheetFuncsBase::FPaloCubeRules( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString() ) );
}
...
void SpreadsheetFuncs::FPaloGetdataExport( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if ( arg_len == 13 || ( arg_len == 14 && use_rules ) )
		ger = SpreadsheetFuncsBase::FPaloGetdataExport( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getBool(), arg[4].getBool(), arg[5].getCellValue(), arg[6].getCellValue(), arg[7].getString(), arg[8].getString(), arg[9].getString(), arg[10].getUInt(), arg[11].getStringArray(), arg[12].getElementListArray(), use_rules );
	else if ( arg.length() == 12 || ( arg_len == 13 && use_rules ))
		ger = SpreadsheetFuncsBase::FPaloGetdataExport( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getBool(), arg[4].getBool(), arg[5].getCellValue(), arg[6].getCellValue(), arg[7].getString(), arg[8].getString(), arg[9].getString(), arg[10].getUInt(), arg[11].getStringArray(), use_rules );
	else if ( arg.length() == 9 || ( arg_len == 10 && use_rules ))
		ger = SpreadsheetFuncsBase::FPaloGetdataExport( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getBool(), arg[4].getBool(), arg[5].getString(), arg[6].getUInt(), arg[7].getStringArray(), arg[8].getElementListArray(), use_rules );
	else if ( arg.length() == 8 || ( arg_len == 9 && use_rules ) )
		ger = SpreadsheetFuncsBase::FPaloGetdataExport( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getBool(), arg[4].getBool(), arg[5].getString(), arg[6].getUInt(), arg[7].getStringArray(), use_rules );
	else
		throw WrongParamCountException( CurrentSourceLocation );
...
SubsetResults SpreadsheetFuncs::FPaloSubset( GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if (( arg.length() >= 5 ) && ( alias.active = !arg[4].isMissing() ) ) { 
		StringArray aliases = arg[4].getStringArray();

		if ( aliases.size() == 1 || aliases.size() == 2 ) {
			if ( aliases.size() == 1 ) {
	...
	for ( size_t i = 5; i < arg.length(); i++ ) {
		...
		if ( filter_type == "Field" ) {
			if ( field.active ) {
				throw SpreadsheetFuncsException( CurrentSourceLocation, SpreadsheetFuncsErrors::ERROR_DUPLICATE_ARGUMENT );
			}
	...
	return SpreadsheetFuncsBase::FPaloSubset( arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].isMissing() ? 1 : arg[3].getSInt(), basic, text, sorting, alias, field, structural, data );
}
...
void SpreadsheetFuncs::FPaloSubsetSortingFilter( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	/* Limit */
	unsigned int limit_count = LONG_MAX, limit_start = 0;
...
void SpreadsheetFuncs::FPaloRemoveConnection(GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ) {
	...
	if (arg[0].getType() == GenericCell::TString) {
		SpreadsheetFuncsBase::FPaloRemoveConnection(arg[0].getString());
	} else {
		try {
			(*arg[0].getConnection( cp )).logout();
		} catch (...) {
		}
	}
...
CellValue SpreadsheetFuncs::_FPaloGetdataC( GenericCell& server, GenericCell& database, GenericCell& cube, GenericCell& path, const CellValue* *const ptr ) {
	if(server.getType() == GenericCell::TString) {
		return SpreadsheetFuncsBase::FPaloGetdataC(server.getString(), database.getString(), cube.getString(), path.getStringArray(), ptr);
	} else{ 
		return SpreadsheetFuncsBase::FPaloGetdataC(server.getConnection(cp), database.getString(), cube.getString(), path.getStringArray(), ptr);
	}
}
...
void SpreadsheetFuncs::FPaloGetElementId( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(4);
	retval.set(SpreadsheetFuncsBase::FPaloGetElementId(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString()));
}
...
void SpreadsheetFuncs::FPaloGetElementName( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(4);
	retval.set(SpreadsheetFuncsBase::FPaloGetElementName(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getSLong()));
}
...
void SpreadsheetFuncs::FPaloGetDimensionId( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(3);
	retval.set(SpreadsheetFuncsBase::FPaloGetDimensionId(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString()));
}
...
void SpreadsheetFuncs::FPaloGetDimensionName( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(3);
	retval.set(SpreadsheetFuncsBase::FPaloGetDimensionName(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getSLong()));
}
...
void SpreadsheetFuncs::FPaloGetCubeId( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(3);
	retval.set(SpreadsheetFuncsBase::FPaloGetCubeId(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString()));
}
...
void SpreadsheetFuncs::FPaloGetCubeName( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(3);
	retval.set(SpreadsheetFuncsBase::FPaloGetCubeName(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getSLong()));
}
...
void SpreadsheetFuncs::FPaloGetUserForSID( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(2);
	retval.set(SpreadsheetFuncsBase::FPaloGetUserForSID(arg[0].getConnection( cp ), arg[1].getString()));
}
...
void SpreadsheetFuncs::FPaloGetGroupsForSID( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(2);
	retval.set(SpreadsheetFuncsBase::FPaloGetGroupsForSID(arg[0].getConnection( cp ), arg[1].getString()));
}
...
void SpreadsheetFuncs::FPaloGetGroups( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	arg.fixConnection(cp, 0);
	arg.checkArgCount(1);
	retval.set(SpreadsheetFuncsBase::FPaloGetGroups(arg[0].getConnection( cp )));
}
...
void SpreadsheetFuncs::FPaloElementAlias( GenericCell& retval, GenericContext& opts, GenericArgumentArray& arg ){
	...
	retval.set(SpreadsheetFuncsBase::FPaloElementAlias(arg[0].getConnection( cp ), arg[1].getString(), arg[2].getString(), arg[3].getString(), arg[4].getString(), index));
}