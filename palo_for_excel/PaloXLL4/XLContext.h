...
namespace Palo {
	namespace XLL {
		...
		public:
			...
			const Palo::Types::ErrorInfo getError( const XLCellRange::CellKey& key ) const;
		...
		private:
			typedef std::unordered_map<XLCellRange::CellKey, size_t> ErrorMap;
			typedef std::vector<std::string> StringPool;

			ErrorMap errMap;
			StringPool stringPool;

			inline size_t getStringPoolIndex(const std::string& message);
